...
export default function ControlCenter({
  ...
  const presetWallpapers: PresetWallpaper[] = [
    {
      id: "shanchuan",
      name: "治愈帆船",
      url: new URL("../assets/帆船-沙滩-治愈系.webp", import.meta.url).href,
      thumbnail: new URL("../assets/帆船-沙滩-治愈系.webp", import.meta.url).href
    },
    {
      id: "shujia",
      name: "书香角落",
      url: new URL("../assets/书架-书桌文具.webp", import.meta.url).href,
      thumbnail: new URL("../assets/书架-书桌文具.webp", import.meta.url).href
    },
    {
      id: "xiaowu",
      name: "乡野小屋",
      url: new URL("../assets/乡村小屋-乡间小路.webp", import.meta.url).href,
      thumbnail: new URL("../assets/乡村小屋-乡间小路.webp", import.meta.url).href
    },
    {
      id: "yewan",
      name: "云岚夜色",
      url: new URL("../assets/云彩-夜晚-夜景.webp", import.meta.url).href,
      thumbnail: new URL("../assets/云彩-夜晚-夜景.webp", import.meta.url).href
    },
    {
      id: "chengshi",
      name: "华灯盛世",
      url: new URL("../assets/中国-城市建筑.webp", import.meta.url).href,
      thumbnail: new URL("../assets/中国-城市建筑.webp", import.meta.url).href
    },
    {
      id: "erciyuan",
      name: "动漫场景",
      url: new URL("../assets/二次元-动漫场景.webp", import.meta.url).href,
      thumbnail: new URL("../assets/二次元-动漫场景.webp", import.meta.url).href
    },
    {
      id: "diaochuang",
      name: "静谧吊床",
      url: new URL("../assets/吊床-宁静环境.webp", import.meta.url).href,
      thumbnail: new URL("../assets/吊床-宁静环境.webp", import.meta.url).href
    },
    {
      id: "skyline",
      name: "璨烂天际",
      url: new URL("../assets/城市夜景-城市天际线.webp", import.meta.url).href,
      thumbnail: new URL("../assets/城市夜景-城市天际线.webp", import.meta.url).href
    }
  ];
  ...
  const handleReset = () => {
    if (confirm("确定要恢复网页的初始外观与视觉配置吗？")) {
      setWallpaper(presetWallpapers[0].url); // Reset to first healing sailing wallpaper
      setBlurAmount(18);
